...
CNN encoders, frame-stacking, NoisyNets, target networks, multi-step returns, and epsilon-schedule strategies.
  ...
  • Then moved onto a childhood favourite called CubeField to test a RL agents capabilities

Shows capability in math-heavy RL, PyTorch engineering, and deep-learning experimentation.
