...
abstract: |
  ...
  low-cost, real-time home-security platform suitable for residential and
  small-scale commercial use.

summary: |
  A multi-modal AI-based home security robot combining facial recognition,
  audio classification, motion detection, and cloud alerts. Presented at EECON 46.
